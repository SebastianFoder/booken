...
const updateDimensions = (
	...
	const offsetX = -Math.abs(Math.floor(Math.random() * (x - window.innerWidth)));
	const offsetY = -Math.abs(Math.floor(Math.random() * (y - window.innerHeight)));
	...
	return (
		<div
			...
			style={{
				...
				overflow: 'hidden',
				zIndex: -1,
				transition: 'transform 0.1s ease-out', // Smooth transition for immersion
			}}
		>
			<Image
				src='/libray1000x.jpg'
